    ...
    <div id="mainbody_contentbody_contentpage_upPannel">
            ...
            <div class="col-xs-12 pro-row">
                        ...
                        <div class="col-md-6 pro-col pro-line14">
                            ...
                            <span title="Lượt xem" class="pro-20"><b>0</b></span>
                            @if($file->tinhtrang==0)
                            <span class="pro-15" title="Đang chờ BQT duyệt"><span class="label label-warning">Chờ</span></span>
                            @else
                            <span class="pro-15" title="Đã duyệt"><span class="label label-success">Duyệt</span></span>
                            @endif

                            <span class="pro-25 text-center">

                        <a href="sua-code-{{$file->id}}" data-toggle="tooltip" data-placement="top" title="Sửa thông tin của code"><i class="fa fa-pencil orange" aria-hidden="true"></i></a>
                                &nbsp;
                            </span>
                        </div>
                    </div>
