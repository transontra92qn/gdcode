        ...
        <form id="formupload">
            <meta name="csrf-token" content="{{ csrf_token() }}">
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <div class="u_image">
                                    ...
                                    <img id="imgUpdateCode" class="u_image_edit">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input name="txtTitle" type="text" maxlength="200" id="contentpage_txtTitle" class="form-control" onblur="ValidateTitle()" placeholder="Tối thiểu 20 kí tự">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <textarea name="txtSubTitle" rows="2" cols="20" id="txtSubTitle" class="form-control up-textarea" onblur="ValidateSub()" placeholder="Tối thiểu 70 kí tự" maxlength="200" style="height:60px;"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input name="txtLinkDemo" type="text" maxlength="300" id="txtLinkDemo" title="Link demo sản phẩm thực tế đã triển khai từ code" class="form-control" onblur="ValidateDemo()" placeholder="Link live demo (Nếu có)">
                    ...
                    <div class="form-group">
                            <label class="col-md-2 control-label bold">Source code</label>
                            <div class="col-md-7">
                                <div class="upload_file">
                                    <div class="f_control">
                                       <div class="f_upload_file"> chọn source
                                             <input type="file" name="SourceUpload" id="SourceUpload" onchange="sourcechange()"  class="upload" accept=".zip,.rar,.rar4">
                                        </div>
                                    <div class="mess alignleft" id="namesource">
                                        </div>

                                    </div>
                                    <span id="lblListImage"></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                <div class="upload_file">
                                    <div class="f_control">
                                        <div class="f_upload_file">
                                            Thêm ảnh...
                                    <input type="file" multiple="multiple" name="FileUpload2[]" onchange="change()" id="FileUpload2" class="upload" accept="image/gif, image/jpeg, image/png">
                                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10" id="editorDetail">
                                <textarea id="ta_mota" name="ta_mota"  rows="10" cols="90"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label bold">Hướng dẫn cài đặt</label>
                            <div class="col-md-10">
                               <textarea id="ta_hd" name="ta_hd" rows="10"  cols="90"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-6">
                                <a id="contentpage_btnUpload" class="button-orange" ><i class="fa fa-cloud-upload fa-lg" aria-hidden="true"></i>&nbsp;TẢI LÊN NGAY</a>
                                &nbsp;&nbsp;
                            </div>
                        </div>
                    </div>
